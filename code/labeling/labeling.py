...
class labelingApp(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.review_label.place(x=WIDTH/100, y=HEIGHT/20,
                                width=WIDTH/10, height=HEIGHT/20-3)
        self.translated_review_label = tk.Label(self, text='review(google翻訳)',
                                                font=('', 20, 'bold'),
                                                foreground='#ffffff',
                                                background='#aa00aa')
        self.translated_review_label.place(
            x=WIDTH/2+WIDTH/100, y=HEIGHT/20, width=WIDTH/3.5, height=HEIGHT/20-3)
        ...
        self.review_field.place(x=WIDTH/100, y=HEIGHT/10,
                                width=WIDTH/2-2*(WIDTH/100), height=6*HEIGHT/10)
        ...
        self.translated_review_field.place(
            x=WIDTH/2+WIDTH/100, y=HEIGHT/10, width=WIDTH/2-2*(WIDTH/100), height=6*HEIGHT/10)
        self.display_review()
